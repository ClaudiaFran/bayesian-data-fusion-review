# Bayesian Data Fusion Developments for Causal Inference
**Augmenting Clinical Trials with Real-World Observational Evidence**

**Author:** Claudia Franceschini  
**Affiliation:** Department of Statistical Sciences, University of Padua  
**Course:** Theory and Methods of Inference (2026)  

---

## Overview
This repository contains the review paper and presentation slides developed for the *Theory and Methods of Inference* PhD course at the University of Padua.
...
- [**Presentation Slides (PDF)**](slides.pdf) — 14-slide conference/seminar presentation deck.
- [**LaTeX Source**](slides.tex) — Beamer source code and assets.
